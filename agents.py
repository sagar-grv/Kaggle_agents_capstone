...
class AccountAgent(Agent):
    def handle(self, email, customer):
        ...
        Task: Write a helpful, professional, and personalized email response.
...
class CardAgent(Agent):
    def handle(self, email, customer):
        ...
        prompt = f"""
        You are a Security Officer at BankAssist.
        ...
        Task: Write a reassuring and clear email response.
        - If the card was blocked, confirm it clearly and instruct them to visit a branch for a replacement.
...
class LoanAgent(Agent):
    def handle(self, email, customer):
        ...
        Task: Write a helpful email regarding their loan inquiry.
